<aside class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        {{-- ============================================
             MANAJEMEN GUDANG (Owner, Kepala Produksi, Mandor)
        ============================================ --}}
        ...
        @can('warehouse.view')
            <a href="{{ route('warehouse.index') }}"
                class="sidebar-link {{ Request::routeIs('warehouse.*') ? 'active' : '' }}">
        ...
        {{-- QC & Loading: Mandor + Kepala Produksi + Owner --}}
        @hasanyrole(['Owner', 'Kepala Produksi', 'Mandor'])
            <a href="{{ route('warehouse.validation') }}"
                class="sidebar-link {{ Request::routeIs('warehouse.validation') ? 'active' : '' }}">
                <i class="bi bi-patch-check-fill"></i>
                <span>Validasi QC</span>
            </a>
            <a href="{{ route('warehouse.loading') }}"
                class="sidebar-link {{ Request::routeIs('warehouse.loading') ? 'active' : '' }}">
        ...
        {{-- ============================================
             DISTRIBUSI & LOGISTIK (Owner, Kepala Lapangan, Driver)
        ============================================ --}}
        ...
        @can('delivery.view')
            <a href="{{ route('delivery.index') }}"
                class="sidebar-link {{ Request::routeIs('delivery.index') ? 'active' : '' }}">
        ...
        @canany(['delivery.approve', 'delivery.create'])
            <a href="{{ route('delivery.assign-driver') }}"
                class="sidebar-link {{ Request::routeIs('delivery.assign-driver') ? 'active' : '' }}">
                <i class="bi bi-person-plus-fill"></i>
                <span>Assign Driver</span>
            </a>
            <a href="{{ route('delivery.monitoring') }}"
                class="sidebar-link {{ Request::routeIs('delivery.monitoring') ? 'active' : '' }}">
        ...
        @can('driver.view')
            <a href="{{ route('driver.index') }}"
                class="sidebar-link {{ Request::routeIs('driver.index') ? 'active' : '' }}">
        ...
        @can('gps.view')
            <a href="{{ route('tracking.index') }}"
                class="sidebar-link {{ Request::routeIs('tracking.index') ? 'active' : '' }}">
                <i class="bi bi-geo-alt-fill"></i>
                <span>Pelacakan GPS</span>
            </a>
        @endcan

        @hasanyrole(['Owner', 'Kepala Lapangan'])
            <a href="{{ route('delivery.incident') }}"
                class="sidebar-link {{ Request::routeIs('delivery.incident') ? 'active' : '' }}">
        ...
        @can('audit.view')
            ...
            <a href="{{ route('audit.index') }}"
                class="sidebar-link {{ Request::routeIs('audit.index') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-logout" id="btn-logout" title="Keluar dari Sistem"
                onclick="document.getElementById('sidebar-logout-form').submit()" style="cursor: pointer;">
