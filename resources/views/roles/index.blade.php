            ...
            <div class="col-12 col-md-6 col-xl-3">
                <div class="erp-card p-4 h-100" style="border-top: 3px solid {{ $style['border'] }};">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div class="d-flex align-items-center gap-2">
                            <div class="rounded p-2"
                                style="background: {{ $style['bg'] }}; color: {{ $style['text'] }}; font-size: 1.1rem;">
                            ...
                            <div>
                                ...
                                @if ($isProtected)
                                    <span class="badge text-xs"
                                        style="background: {{ $style['bg'] }}; color: {{ $style['text'] }};">Sistem</span>
                                @endif
                            </div>
                        </div>
                        @if (!$isProtected)
                    ...
                    <div class="d-flex gap-4">
                        <div>
                            <div class="fw-bold fs-5" style="color: {{ $style['text'] }};">
                ...
                <tbody>
                    @foreach ($permissions as $perm)
                        ...
                        <tr>
                            <td>
                                <code class="text-xs"
                                    style="color: var(--accent-indigo, #4B6EF5);">{{ $perm->name }}</code>
                            </td>
                            @foreach ($roles as $role)
                                <td>{!! $has($role, $perm->name)
                                    ? '<i class="bi bi-check-circle-fill text-success"></i>'
                                    : '<i class="bi bi-dash text-muted opacity-25"></i>' !!}</td>
                            @endforeach
                        </tr>
                    @endforeach
                </tbody>
